...
This is emergency call data from the [Budget Office of the City of Portland](https://www.portlandoregon.gov/cbo/). It has only five columsn but nearly 1.4 million rows as it has nearly 3 years of call data. Like many datasets, this data comes in an especially hefty 45MB excel file and is spread over four sheets (download [here]("../DataSetsforPSUWorkshop.xlsx")).
