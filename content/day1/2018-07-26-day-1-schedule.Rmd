...
sched <- tribble(~Time, ~Goals, ~Materials, ~Data,
                 ...
                 paste0('[Excel Master Sheet]','(static/data/DataSetsForPSUWorkshop.xlsx)'),
                 "1:00-2:15pm", "Tidyverse cont.", NA, paste0('[Excel Master Sheet]','(static/data/DataSetsForPSUWorkshop.xlsx)'),
